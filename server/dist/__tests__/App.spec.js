...
describe('App', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    return [4 /*yield*/, connection.query('DROP TABLE IF EXISTS tickets')];
                case 2:
                    _a.sent();
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.query('DELETE FROM tickets')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should be able to create a new product', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default).post('/tickets').send({
                        name: 'Produto 01',
                        price: 500,
                        quantity: 50,
                    })];
